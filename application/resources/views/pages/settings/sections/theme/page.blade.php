...
@section('settings-page')
    ...
    <form class="form">
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_theme_name" name="settings_theme_name">
                    @foreach (config('theme.list') as $theme)
                        <option value="{{ $theme }}"
                            {{ runtimePreselected($theme, $settings->settings_theme_name ?? '') }}>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-12 p-t-5">
                <textarea class="form-control form-control-sm" rows="10" name="settings_theme_head" id="settings_theme_head">{{ $settings->settings_theme_head }}</textarea>
            </div>
        </div>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-12 p-t-5">
                <textarea class="form-control form-control-sm" rows="10" name="settings_theme_body" id="settings_theme_body">{{ $settings->settings_theme_body }}</textarea>
            </div>
        </div>
