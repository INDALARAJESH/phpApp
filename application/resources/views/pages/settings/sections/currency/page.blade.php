    ...
    <form class="form" id="settingsFormCurrency">
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                ...
                <select class="select2-basic form-control form-control-sm select2-preselected"
                    id="settings_system_currency_code" data-preselected="{{ $settings->settings_system_currency_code ?? '' }}"
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                class="btn btn-rounded-x btn-danger waves-effect text-left" data-url="/settings/currency"
