    ...
    <form class="form" id="settings-projects-automation">
        ...
        <div class="form-group row p-b-10">
            <label class="col-sm-12 text-left control-label col-form-label">@lang('lang.project_automation_default') <span
                    class="align-middle text-info font-16" data-toggle="tooltip" title="@lang('lang.project_automation_default_info')"
        ...
        <div class="{{ projectAutomationVisibility($settings->settings2_projects_automation_default_status) }}"
            ...
            <div class="alert alert-info m-b-20 m-t-25">
                <h6>@lang('lang.automation_option')</h6> @lang('lang.project_automation_info_1'): <span class="align-middle text-info font-16"
                    data-toggle="tooltip" title="@lang('lang.project_automation_info_2')" data-placement="top"><i class="ti-info-alt"></i></span>
            </div>

            <!--settings2_projects_automation_create_invoices-->
            <div class="form-group form-group-checkbox row m-b-20">
                <div class="col-12">
                    <label class="text-left control-label col-form-label p-r-3 required">@lang('lang.automation_invoice_project')</label>
            ...
            <div class="card-contrast-panel m-l-30 {{ projectAutomationVisibility($settings->settings2_projects_automation_create_invoices) }}"
                ...
                <div class="form-group form-group-checkbox row m-b-0">
                    <label class="col-sm-12 col-lg-4 col-form-label text-left">@lang('lang.automation_generate_invoice_from_estimates')</label>
                ...
                @if (config('visibility.foooo_bar'))
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-4 col-form-label text-left">@lang('lang.automation_invoice_unbilled_hours')</label>
                        <div class="col-sm-12 col-lg-8 text-left p-t-5">
                ...
                <div class="form-group form-group-checkbox row">
                    <label class="col-sm-12 col-lg-4 col-form-label text-left">@lang('lang.automation_email_invoices_to_client')</label>
                    <div class="col-sm-12 col-lg-8 text-left p-t-5">
                        <input type="checkbox" id="settings2_projects_automation_invoice_email_client"
                            ...
                            name="settings2_projects_automation_invoice_email_client"
                            class="filled-in chk-col-light-blue">
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                class="btn btn-rounded-x btn-danger waves-effect text-left" data-url="/settings/projects/automation"
