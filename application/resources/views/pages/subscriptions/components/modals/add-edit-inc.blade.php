@if ($show == 'form')
    @if (count($products ?? []) > 0)
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.plan')) }}
                <a class="align-middle font-14 toggle-collapse" href="#stripe_products_info" role="button"><i
                        class="ti-info-alt text-themecontrast"></i></a></label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm dynamic-select2-price"
                    id="subscription_gateway_price" name="subscription_gateway_price" disabled>
                </select>
            </div>
        </div>
        ...
        <div class="form-group form-group-checkbox row">
            <div class="col-12 text-left p-t-5">
                <input type="checkbox" id="show_after_adding" name="send_email_to_customer"
