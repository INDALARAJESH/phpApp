<div class="setup-welcome" id="setup-welcome">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12">
            <input type="text" class="form-control form-control-sm" name="purchase_code" value="">
        </div>
    </div>
    ...
    <div class="x-button m-t-30">
        <button type="button" class="btn waves-effect waves-light btn-block btn-info js-ajax-request"
            ...
            data-form-id="setup-welcome" data-ajax-type="post" data-url="{{ url('setup/requirements') }}">Start
            Installation</button>
    </div>
