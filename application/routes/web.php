...
Route::group(['prefix' => 'clients'], function () {
    ...
    Route::post("/delete", "Clients@destroy");
    ...
    Route::put("/logo", "Clients@updateLogo");
...
Route::group(['prefix' => 'contacts'], function () {
    ...
    Route::post("/delete", "Contacts@destroy");
});
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::put("/updatenotifications", "User@updateNotificationsAction");
    Route::post("/updatelanguage", "User@updateLanguage");
    Route::get("/updatetheme", "User@updateTheme");
    Route::put("/updatetheme", "User@updateThemeAction");
});

//INVOICES
Route::group(['prefix' => 'invoices'], function () {
    Route::any("/search", "Invoices@index");
    Route::post("/delete", "Invoices@destroy");
...
Route::group(['prefix' => 'subscriptions'], function () {
    ...
    Route::post("/delete", "Subscriptions@destroy");
    ...
    Route::get("/{subscription}/cancel", "Subscriptions@cancelSubscription")->where('subscription', '[0-9]+');;
});
...
Route::group(['prefix' => 'estimates'], function () {
    ...
    Route::post("/delete", "Estimates@destroy");
...
Route::group(['prefix' => 'payments'], function () {
    ...
    Route::post("/delete", "Payments@destroy");
...
Route::group(['prefix' => 'items'], function () {
    ...
    Route::post("/delete", "Items@destroy");
...
Route::group(['prefix' => 'expenses'], function () {
    ...
    Route::delete("/attachments/{uniqueid}", "Expenses@deleteAttachment");
    Route::post("/delete", "Expenses@destroy");
...
Route::group(['prefix' => 'projects'], function () {
    ...
    Route::post("/delete", "Projects@destroy");
...
Route::group(['prefix' => 'tasks'], function () {
    ...
    Route::post("/delete", "Tasks@destroy");
    ...
    Route::delete("/delete-attachment/{uniqueid}", "Tasks@deleteAttachment");
...
Route::group(['prefix' => 'leads'], function () {
    ...
    Route::post("/delete", "Leads@destroy");
...
Route::group(['prefix' => 'tickets'], function () {
    ...
    Route::post("/delete", "Tickets@destroy");
...
Route::group(['prefix' => 'timesheets'], function () {
    ...
    Route::post("/delete", "Timesheets@destroy");
});
...
Route::group(['prefix' => 'files'], function () {
    ...
    Route::post("/delete", "Files@destroy");
    Route::post("/{file}/rename", "Files@renameFile");
    ...
    Route::delete("/folders/{folder}/delete", "Files@deleteFolder")->where('folder', '[0-9]+');
    Route::post("/move", "Files@ShowMoveFiles");
    Route::put("/move", "Files@moveFiles");
...
Route::group(['prefix' => 'notes'], function () {
    ...
    Route::post("/delete", "Notes@destroy");
});
...
Route::group(['prefix' => 'comments'], function () {
    ...
    Route::post("/delete", "Comments@destroy");
});
...
Route::group(['prefix' => 'proposals'], function () {
    ...
    Route::post("/delete", "Proposals@destroy");
...
Route::group(['prefix' => 'contracts'], function () {
    ...
    Route::post("/delete", "Contracts@destroy");
...
Route::group(['prefix' => 'settings/taxrates'], function () {
    ...
    Route::put("/", "Settings\Taxrates@update");
});
...
Route::group(['prefix' => 'settings/estimates'], function () {
    ...
    Route::put("/", "Settings\Estimates@update");
...
Route::group(['prefix' => 'settings/contracts'], function () {
    ...
    Route::put("/", "Settings\Contracts@update");
});

//SETTINGS - PROPOSALS
Route::group(['prefix' => 'settings/proposals'], function () {
    Route::get("/", "Settings\Proposals@index");
    Route::put("/", "Settings\Proposals@update");
});

//SETTINGS - EXPENSES
Route::group(['prefix' => 'settings/expenses'], function () {
    Route::get("/", "Settings\Expenses@index");
    Route::put("/", "Settings\Expenses@update");
});

//SETTINGS - STRIPE
Route::group(['prefix' => 'settings/stripe'], function () {
    Route::get("/", "Settings\Stripe@index");
    Route::put("/", "Settings\Stripe@update");
});

//SETTINGS - RAZORPAY
Route::group(['prefix' => 'settings/razorpay'], function () {
    Route::get("/", "Settings\Razorpay@index");
    Route::put("/", "Settings\Razorpay@update");
});

//SETTINGS - MOLLIE
Route::group(['prefix' => 'settings/mollie'], function () {
    Route::get("/", "Settings\Mollie@index");
    Route::put("/", "Settings\Mollie@update");
});

//SETTINGS - PAYPAL
Route::group(['prefix' => 'settings/paypal'], function () {
    Route::get("/", "Settings\Paypal@index");
    Route::put("/", "Settings\Paypal@update");
});

//SETTINGS - TAP
Route::group(['prefix' => 'settings/tap'], function () {
    Route::get("/", "Settings\Tap@index");
    Route::put("/", "Settings\Tap@update");
});

//SETTINGS - BANK
Route::group(['prefix' => 'settings/bank'], function () {
    Route::get("/", "Settings\Bank@index");
    Route::put("/", "Settings\Bank@update");
});
...
Route::group(['prefix' => 'settings/leads'], function () {
    ...
    Route::put("/statuses", "Settings\Leads@updateStatuses");
    Route::get("/statuses/{id}/edit", "Settings\Leads@editStatus")->where('lead', '[0-9]+');
    Route::put("/statuses/{id}", "Settings\Leads@updateStatus")->where('lead', '[0-9]+');
    ...
    Route::delete("/statuses/{id}", "Settings\Leads@destroyStatus")->where('id', '[0-9]+');
...
Route::group(['prefix' => 'settings/webforms'], function () {
    ...
    Route::put("/", "Settings\Webforms@update");
...
Route::group(['prefix' => 'settings/tasks'], function () {
    ...
    Route::put("/", "Settings\Tasks@update");

    Route::get("/statuses", "Settings\Tasks@statuses");
    Route::put("/statuses", "Settings\Tasks@updateStatuses");
    Route::get("/statuses/{id}/edit", "Settings\Tasks@editStatus")->where('task', '[0-9]+');
    Route::put("/statuses/{id}", "Settings\Tasks@updateStatus")->where('task', '[0-9]+');
    ...
    Route::delete("/statuses/{id}", "Settings\Tasks@destroyStatus")->where('id', '[0-9]+');
...
Route::group(['prefix' => 'settings/email'], function () {
    ...
    Route::put("/general", "Settings\Email@updateGeneral");
    Route::get("/smtp", "Settings\Email@smtp");
    Route::put("/smtp", "Settings\Email@updateSMTP");
    Route::get("/templates", "Settings\Emailtemplates@index");
    Route::get("/templates/{id}", "Settings\Emailtemplates@show")->where('id', '[0-9]+');
    Route::post("/templates/{id}", "Settings\Emailtemplates@update")->where('id', '[0-9]+');
    Route::get("/testemail", "Settings\Email@testEmail");
    Route::post("/testemail", "Settings\Email@testEmailAction");
    Route::get("/testsmtp", "Settings\Email@testSMTP");
...
Route::group(['prefix' => 'settings/roles'], function () {
    ...
    Route::put("/", "Settings\Roles@update");
    Route::get("/{id}/homepage", "Settings\Roles@editHomePage")->where('id', '[0-9]+');
    Route::put("/{id}/homepage", "Settings\Roles@updateHomePage");
});
Route::resource('settings/roles', 'Settings\Roles');
Route::post("/settings/roles", "Settings\Roles@Store");
...
Route::group(['prefix' => 'settings/tickets'], function () {
    ...
    Route::put("/", "Settings\Tickets@update");
    Route::get("/statuses", "Settings\Tickets@statuses");
    Route::put("/statuses", "Settings\Tickets@updateStatuses");
    Route::get("/statuses/{id}/edit", "Settings\Tickets@editStatus")->where('task', '[0-9]+');
    Route::put("/statuses/{id}", "Settings\Tickets@updateStatus")->where('task', '[0-9]+');
    ...
    Route::delete("/statuses/{id}", "Settings\Tickets@destroyStatus")->where('id', '[0-9]+');
...
Route::group(['prefix' => 'settings/logos'], function () {
    ...
    Route::put("/uploadlogo", "Settings\Logos@updateLogo");
});
...
Route::group(['prefix' => 'settings/subscriptions'], function () {
    ...
    Route::post("/plans", "Settings\Subscriptions@storePlan");
    Route::put("/plans", "Settings\Subscriptions@updatePlan");
});
...
Route::group(['prefix' => 'settings/files'], function () {
    ...
    Route::put("/folders", "Settings\Files@updatefolders");
...
Route::group(['prefix' => 'templates/projects'], function () {
    ...
    Route::post("/delete", "Templates\Projects@destroy");
...
Route::post("/appwebmail/send", "Webmail\Compose@send");
