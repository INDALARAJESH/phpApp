                ...
                <tr>
                    <td colspan="20">
                        <div class="text-right">
                            <!--re-queue emails-->
                            <button type="button"
                                class="btn btn-info btn-sm waves-effect text-left confirm-action-info"
                                data-confirm-title="<?php echo app('translator')->get('lang.queue_all_email_again'); ?>" data-confirm-text="<?php echo app('translator')->get('lang.are_you_sure'); ?>"
                            ...
                            <button type="button"
                                ...
                                data-confirm-title="<?php echo app('translator')->get('lang.delete_all_emails'); ?>" data-confirm-text="<?php echo app('translator')->get('lang.are_you_sure'); ?>"
                                data-ajax-type="DELETE"
...
<?php /**PATH /home/pnmshhgj/manage.upskygroup.com/application/resources/views/pages/settings/sections/email/queue/table.blade.php ENDPATH**/ ?>