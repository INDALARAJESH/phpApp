...
<?php $__env->startSection('settings-page'); ?>
    ...
    <form class="form" id="settingsFormGeneral">
        ...
        <div class="form-group row">
            <label
                class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.kanban_pagination_limits'))); ?></label>
            <div class="col-12">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pnmshhgj/manage.upskygroup.com/application/resources/views/pages/settings/sections/general/general.blade.php ENDPATH**/ ?>