    ...
    <form class="form" id="settingsFormEmailSMTP">
        ...
        <div class="text-right">
            ...
            <button type="button" class="btn btn-info edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                ...
                data-action-type='form' data-action-form-id="test-email-form"" data-modal-size=" modal-lg"
        ...
        <div class="col-12">
            <div class="alert alert-info m-t-40 p-t-30 p-b-30">
                <div class="email-testing-tool-sections" id="email-testing-tool-start">
                    ...
                    <a href="#" class="btn btn-sm btn-primary ajax-request"
                        data-url="<?php echo e(url('settings/email/testsmtp')); ?>" data-onstart-hide="#email-testing-tool-start"
                        data-onstart-show="#email-testing-tool-running" id=""><?php echo app('translator')->get('lang.run_test_now'); ?></a>
                </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pnmshhgj/manage.upskygroup.com/application/resources/views/pages/settings/sections/email/smtp.blade.php ENDPATH**/ ?>