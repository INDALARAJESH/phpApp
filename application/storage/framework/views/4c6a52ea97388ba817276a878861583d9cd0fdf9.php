        ...
        <table id="knowledgebase-categories" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"
            ...
            <thead>
                <tr>
                    ...
                    <th class="category_col_action"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a>
                    </th>
                </tr>
            </thead>
...
<?php /**PATH /home/pnmshhgj/manage.upskygroup.com/application/resources/views/pages/settings/sections/knowledgebase/table/table.blade.php ENDPATH**/ ?>